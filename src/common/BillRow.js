				...
				<View style={{ flex: 0.35 }}>
					<Item style={styles.allBg}>
						<Picker
							...
							onValueChange={value => this.props.change(value, 'month', this.props.values.key)}
						>
				...
				<View style={{ flex: 0.2, alignItems: 'center' }}>
					<Item style={styles.allBg}>
						<Input
							...
							onChangeText={text => this.props.change(text, 'unit', this.props.values.key)}
				...
				<View style={{ flex: 0.25, alignItems: 'center' }}>
					<Item style={styles.allBg}>
						<Input
							...
							style={styles.allColor}
							keyboardType="numeric"
							onChangeText={text => this.props.change(text, 'budget', this.props.values.key)}
